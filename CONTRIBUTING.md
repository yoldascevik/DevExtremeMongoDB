...
1. [Fork](http://help.github.com/fork-a-repo/) the repo, clone your fork,
   ...
   git clone https://github.com/<your-username>/DevExtremeMongoDB
   # Navigate to the newly cloned directory
   cd DevExtremeMongoDB
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/yoldascevik/DevExtremeMongoDB.git
   ```
